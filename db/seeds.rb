...
product_one = Product.new(name: "Kayak", category: "watersports", available: true, description: "This is a great Kayak", price: 100)
product_one.save
puts "product 1 is created"

product_two = Product.new(name: "Surfboard", category: "watersports", available: true, description: "This is a great surfboard", price: 200)
product_two.save
puts "product 2 is created"

product_three = Product.new(name: "bicycle", category: "cycling", available: true, description: "This is a great bike", price: 500)
product_three.save
